    ...
    public class CartController : Controller
    {
        ...
        public ActionResult RedirectToPayPal(int orderId)
        {
            ...
            try
            {
                ...
                // Giả sử giá đơn hàng đang là VND, chuyển sang USD
                decimal exchangeRate = 25000; // 1 USD = 25,000 VND
                decimal vndTotal = order.Total ?? 0;
                decimal usdTotal = Math.Round(vndTotal / exchangeRate, 2); // làm tròn 2 chữ số
